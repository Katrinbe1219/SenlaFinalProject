...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(PermissionDenied ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new StringResponse(ex.getMessage()));
    }

    @ExceptionHandler(RegistrationException.class)
    public ResponseEntity<Map<String, String>> handleNotCorrectInput(RegistrationException ex) {
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(EntityAlreadyExist ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new StringResponse(ex.getMessage()));
    }

    @ExceptionHandler(DoesNoeExist.class)
    public ResponseEntity<StringResponse> handleNotCorrectInput(DoesNoeExist ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new StringResponse(ex.getMessage()));
    }
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(HttpRequestMethodNotSupportedException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new StringResponse(ex.getMessage()));
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    public ResponseEntity<StringResponse> handleNotCorrectInput(NoHandlerFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new StringResponse(ex.getMessage()));
    }

    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    public ResponseEntity<StringResponse> handleNotCorrectInput(MethodArgumentTypeMismatchException ex) {
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(HttpMessageNotReadableException ex) {
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(MissingServletRequestParameterException ex) {
    ...
    public ResponseEntity<StringResponse> handleNotCorrectInput(DataIntegrityViolationException ex) {
