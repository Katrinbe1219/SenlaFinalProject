...
import org.example.application.services.dictionaries.UnitService;
...
public class UnitController {
    ...
    @PostMapping
    public UnitDto createUnit(@RequestBody UnitCreateDto unitDto){
        if (unitDto.getFullName() == null || unitDto.getShortName() == null ||
                unitDto.getFullName().isEmpty() || unitDto.getShortName().isEmpty()){
